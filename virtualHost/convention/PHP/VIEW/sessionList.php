<?php
                    ...
                    foreach ($tableau as $uneSession) {
                        ...
                        echo '<div class="list"><div class="case"> '.substr($formation->getLibelleFormation(),0,-12).'</div><div class="case"> '.$uneSession->getNumOffreFormation().'</div><div class="case"> '.$uneSession->getDateRapportSuivi().'</div>'.
